...
- Prefer unopened links first, then rotate through the full filtered list.
...
Personal links are saved in `links.json` and ignored by Git. A portable example format is available in `links.example.json`.
